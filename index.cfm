...
<!-- Custom Theme files 
<script src="assets/user_template/js/jquery.min.js"></script>
<script src="assets/user_template/js/bootstrap.min.js"></script>-->
<!-- Custom Theme files -->
	...
	<div class="">
		<div class="main-content">
                ...
                <div class="banner col-md-12">
                    <section class="slider">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="assets/user_template/images/pic1.jpg" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="assets/user_template/images/pic2.jpg" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="assets/user_template/images/pic3.jpg" class="img-responsive" alt="" />
                                </li>
                                <li>
                                    <img src="assets/user_template/images/pic4.jpg" class="img-responsive" alt="" />
                                </li>
                            </ul>
                        </div>
                    </section>
			...
			<div class="review-slider">
			    ...
			    <ul id="flexiselDemo1">
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r1.jpg" alt=""/></a>
                    ...
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r2.jpg" alt=""/></a>
                    ...
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r3.jpg" alt=""/></a>
                    ...
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r4.jpg" alt=""/></a>
                    ...
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r5.jpg" alt=""/></a>
                        <div class="slide-title"><h4>Lorem Ipsum is simply Bonorum</h4></div>
                        <div class="date-city">
                            <h5>Dec 12-15</h5>
                            <h6>Multi-city</h6>
                    ...
                    <li>
                        <a href="movies.html"><img src="assets/user_template/images/r6.jpg" alt=""/></a>
                        <div class="slide-title"><h4>Lorem Ipsum is simply Bonorum</h4></div>
                        <div class="date-city">
                            <h5>Dec 12-15</h5>
                            <h6>Multi-city</h6>
